...
- **App.jsx** – Main container that renders all components.  
- **Card.jsx** – Individual job card component.  
- **Header.jsx** – Navigation bar with search and links.  
- **Filter.jsx** – Dropdown filter component.  
- **Footer.jsx** – Footer with animated background effects.

---

## ⚡ Future Enhancements

- Connect to a backend (Django / Node.js) for real-time job data.  
- Implement functional search and filter options.  
- Add authentication for saving favorite jobs.  
- Pagination or infinite scroll for handling large job lists.  
...
**Mobile View:**  
![Mobile Screenshot](https://via.placeholder.com/300x600.png?text=Mobile+View)  
